...
input_dir = '/Users/Alessandro/Desktop/DRL 2/NAS Results/Multi_Ticker/RL INPUT/'

# Directory di output per i file normalizzati
output_dir = '/Users/Alessandro/Desktop/DRL 2/NAS Results/Multi_Ticker/Normalized_RL_INPUT/'
...
for csv_path in tqdm(csv_files, desc="Normalizzazione file CSV"):
    ...
    json_output_path = os.path.join('/Users/Alessandro/Desktop/DRL 2/NAS Results/Multi_Ticker/Normalized_RL_INPUT/json', f"{ticker}_norm_params.json")
